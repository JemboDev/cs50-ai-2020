...
# Done by JemboDev (Alexander Saprygin) @ 05.11.20
...
class MinesweeperAI():
    ...
    def get_neighbors(self, cell):
        """
        Returns set of neighboring cells
        whose state is still undetermined.
        """
        cells = set()
        ...
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # If cell in bounds and not in safes or mines
                if 0 <= i < self.height and 0 <= j < self.width:
                    cells.add((i, j))
        return cells
    ...
    def add_knowledge(self, cell, count):
        ...
        # Marking mines and safes based on a sentences in KB
        mines_to_mark = set()
        safes_to_mark = set()
        ...
        # Inferring and adding new sentences
        new_sentences = []
